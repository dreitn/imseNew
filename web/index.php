...
//$database->selectAllCostumers($conn, 'email', '100', 'first', 'last', '1');

//$database->selectAllBill($conn, "1","183","2020-05-05","Claire_Cavanagh8658@iatim.tech");
...
$bill_array = $database->selectAllBill($conn, $billnr, $total, $date, $c_mail);
?>
...
<form method="get">
    ...
    <div>
        ...
        <input id="email" name="email" type="text" value='<?php echo $email; ?>' maxlength="20">
    </div>
    <br>
